					...
					<div class="col-sm">
						...
						<div>
							...
							<button class="btn btn-primary" type="button"
								onclick="searchId()">아이디찾기</button>
						<button class="btn btn-primary" type="button"
								onclick="resetPw()">비밀번호재설정</button>
						</div>
	...
	<div class="modal fade" id="exampleModal1" tabindex="-1"
		...
		<form action="resetpw.do" method="post">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel1">비밀번호재설정</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal"
							aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<div class="form-floating mb-2">
							...
							<label for="id" class="form-label">등록하신 아이디를 입력해주세요</label>
						</div>
						<div class="form-floating mb-2">
							<input type="text" name="email" id="email" class="form-control" />
							<label for="email" class="form-label">등록하신 이메일을 입력해주세요</label>
					...
					<div class="modal-footer">
						<input type="submit" class="btn btn-primary" onclick ="resetPw()"value="확인" />
						<button type="button" class="btn btn-secondary"
							data-bs-dismiss="modal">취소</button>
					</div>
				</div>
